...
coresignal::coresignal(int sample_rate, int buffer_size)
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void coresignal::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float coresignal::getParamValue(const std::string& path)
{
...
extern "C" void app_main()
{
    ...
    coresignal* DSP = new coresignal(48000, 32);
    DSP->start();
